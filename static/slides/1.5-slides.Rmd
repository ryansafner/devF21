---
title: "1.5 — The Socialist Calculation Debate"
...
.smallest[
> "[A]s soon as one gives up the conception of a freely established monetary price for goods of a higher order, rational production becomes completely impossible. .hi[Every step that takes us away from private ownership of the means of production and from the use of money also takes us away from rational economics]," (p.14).

> "Thus in the socialist commonwealth every economic change becomes an undertaking whose success can be neither appraised in advance nor later retrospectively determined. There is only groping in the dark. .hi[Socialism is the abolition of rational economy]," (p.17).
