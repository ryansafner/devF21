...
- <i class="fas fa-chalkboard-teacher"></i> **Slides** are "[Xaringan](https://github.com/yihui/xaringan)" presentations in html that can be opened in any browser (You can find a downloadable <i class="fas fa-file-pdf"></i> `PDF` in each respective <i class="fas fa-info-circle"></i> **content** page)
