---
title: "3.3 — The Diamond Hypothesis"
...
### [Geography's Mechanisms: Trade and Health](#45)
### [Geography and Trade/Market Access](#47)
### [Geography and Health](#64)
...
.left-column[
.center[
![](../images/diamondyali.jpg)

*Guns, Germs, and Steel* ([PBS](https://www.pbs.org/gunsgermssteel/show/index.html))
]
]
...
.center[
![:scale 100%](../images/cargocult.jpg)
]
...
.center[
![:scale 75%](../images/pizarroinca.jpg)
...
.pull-right[
.center[
![:scale 75%](../images/cowandsheep.jpg)
]
]
...
- .hi-turquoise[Ideas, best practices, and technology can more easily spread *East-West* than *North-South*]
...
.pull-right[
.center[
![:scale 100%](../images/ggsfoodsources.png)
]
...
.pull-right[
.center[
![:scale 60%](../images/ggsdiagram.png)
]
]
...
.center[
![:scale 70%](../images/pizarroinca.jpg)
...
.pull-right[
.center[
![:scale 100%](../images/europeanfarm.jpg)
]
]
...
.left-column[
.center[
![:scale 80%](../images/johnwinthrop.jpg)
.smallest[
John Winthrop
...
- GDP/capita today (WB, 2021):
  - .orange[France: $38,625] (Source: [WB, 2021](https://data.worldbank.org/indicator/NY.GDP.PCAP.CD?locations=FR))
  - .green[China: $10,500] (Source: [WB, 2021](https://data.worldbank.org/indicator/NY.GDP.PCAP.CD?locations=CN))
...
.pull-right[
.center[
![:scale 100%](../images/francechina.png)
]
...
.center[
![:scale 60%](../images/deeproots1.png)
]
...
> These empirical results provide .hi[strong evidence in favor of Diamond’s hypotheses,] while suggesting that .hi[the geographic component of the story is empirically more relevant than the biological component.] Column 6 goes further in the attempt to control for the effect of post-1500 population movements, by restricting the sample to the Old World (defined as all countries minus the Americas and Oceania). The effect of geography now rises to 64 percent—again highly .hi[consistent with Diamond’s idea that biogeographic conditions matter mostly in the Old World]," (p.5).
...
.center[
![:scale 50%](../images/deeproots2.png)
]
...
.center[
![:scale 65%](../images/populationdensity1500.png)
]
...
- Malthusian dynamics of a pre-modern economy
  - More prosperous regions have high population $\implies$ lowers real wages
...
.center[
![:scale 85%](../images/population_density_over_time.png)
]
...
.center[
![:scale 60%](../images/easterlydeeprootsurb.png)
]
...
.center[
![:scale 90%](../images/easterlydeeprootsscatter.png)
...
.pull-right[
.smallest[
“1500 AD technology is a particularly powerful predictor of per capita income today. 78 percent of the difference in income today between sub-Saharan Africa and Western Europe is explained by technology differences that already existed in 1500 A.D. – even BEFORE the slave trade and colonialism...Moreover, these technological differences had already appeared by 1000 BC. The state of technology in 1000 BC has a strong correlation with technology 2500 years later, in 1500 AD.” - Easterly, [blog post](http://www.nyudri.org/aidwatcharchive/2010/07/was-the-poverty-of-africa-determined-in-1000-bc?rq=1000%20bc) about paper
...
- In the language of the literature, and econometrics, what are the specific .hi-turquoise[mechanisms] or .hi-tuqruoise[channels] by which (good/bad) geography leads to (high/low) growth?
...
.center[
![:scale 70%](../images/sachscoast.png)
]
...
.center[
![:scale 80%](../images/sachscoasteurope.png)
]
]
...
.center[
![:scale 80%](../images/sachscoastchina.png)
]
]
...
.center[
![:scale 70%](../images/sachscoastusa.png)
]
...
.center[
![:scale 45%](../images/sachscoastafrica.png)
]
...
.center[
![:scale 70%](../images/mercatorproj.JPG)
]
...
.center[
![:scale 90%](../images/Mollweide_projection_SW.jpg)
]
...
.center[
![:scale 70%](../images/africasize.jpg)
]
...
.center[
![:scale 85%](../images/sachs_geog_continents.png)
]
...
.center[
![:scale 60%](../images/latitudegdp.png)
...
.center[
![:scale 60%](../images/malariaindex.png)
]
...
.smaller[
> "This study estimates .hi[long-run impacts] of a child health investment, exploiting community-wide experimental variation [i.e. an RCT] in .hi[school-based deworming]. The program increased labor supply among men and education among women, with accompanying shifts in labor market specialization. .hi[Ten years after de-worming treatment, men] who were eligible as boys .hi[stay enrolled for more years of primary school, work 17% more hours each week, spend more time in non-agricultural self-employment, are more likely to hold manufacturing jobs, and miss one fewer meal per week.] .hi[Women] who were in treatment schools as girls .hi[are approximately one quarter more likely to have attended secondary school, halving the gender gap.] They .hi[reallocate time from traditional agriculture into cash crops and  nonagricultural self-employment.] We estimate a conservative annualized financial internal .hi[rate of return to deworming of 32%], and show that .hi[mass deworming may generate more in future government revenue than it costs in subsidies.]
...
.left-column[
.center[
![](../images/accidental_superpower.jpg)
]
]
...
.source[[A good review of the book](https://astralcodexten.substack.com/p/your-book-review-the-accidental-superpower), which I have not yet read.]
]
