...
![](https://devF21.classes.ryansafner.com/images/acbsp.png)
...
**You can find a full schedule** with much more details, including the readings, appendices, and other further resources for each class meeting on the [schedule page](http://devF21.classes.ryansafner.com/schedule/).